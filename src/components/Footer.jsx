    ...
    return (
        <footer className="mt-20 border-t border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-slate-900/50 transition-colors duration-300">
            <div className="max-w-[1400px] mx-auto px-6 py-10">
                <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-4 sm:gap-8 text-sm font-medium text-gray-600 dark:text-gray-400">
                    <a
                        href="https://github.com/rohankumardubey"
                        target="_blank"
                        rel="noreferrer"
                        className="hover:text-gray-900 dark:hover:text-white transition-colors"
                    >
                        Built by Rohan Dubey
                    </a>

                    <a
                        href="https://github.com/rohankumardubey/leetcode-companywise-prep"
                        target="_blank"
                        rel="noreferrer"
